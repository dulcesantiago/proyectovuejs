  ...
  >
    ...
    >
      ...
      <ItemSidebar :active="$route.name == 'Home'" to="/"
        ><template #icon><i class="bx bx-cloud"></i></template> Mi Nube
      </ItemSidebar>
      ...
      <ItemSidebar :active="$route.name == 'Starred'" to="/starred"
        ><template #icon><i class="bx bx-star"></i></template> Destacados
      </ItemSidebar>
      <ItemSidebar :active="$route.name == 'Trash'" to="/trash"
        ><template #icon><i class="bx bx-trash-alt"></i></template> Archivos reciclados
      </ItemSidebar>
      <template #footer>
        <span class="text-gray-600 dark:text-white"
          >25.32 GB <span class="text-xs">used</span></span
        >
        <div class="text-xs text-gray-600 mb-2 dark:text-white">70% used - 1.2 GB free</div>
...
.cloud-app{
  background-image: linear-gradient(to right top, #051937, #1e496a, #3d7f9d, #67b9cd, #9cf6f9);
}
* {
